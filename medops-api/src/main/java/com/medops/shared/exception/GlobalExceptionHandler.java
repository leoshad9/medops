...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAccessDenied(AccessDeniedException ex) {
        return build(HttpStatus.FORBIDDEN, "PERMISSION_DENIED", "You do not have permission to perform this action", null);
    }
     ...
     */
    private ResponseEntity<ErrorResponse> build(HttpStatus status, String googleStatus, String message, List<String> details) {
